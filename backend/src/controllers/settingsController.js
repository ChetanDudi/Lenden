...
const { sendAlternativeEmailOTP: sendEmail } = require('../utils/email/alternativeEmailOtp');
const { sendSetPasswordOTP: sendSetPasswordEmail } = require('../utils/email/setPasswordOtp');
const { sendChangePasswordOTP: sendChangePasswordEmail } = require('../utils/email/changePasswordOtp');
const { sendAccountDeletedEmail } = require('../utils/email/accountDeletedEmail');
