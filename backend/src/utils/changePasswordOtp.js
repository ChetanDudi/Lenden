  ...
  <tr><td align="center">
    <table width="580" cellpadding="0" cellspacing="0" border="0" style="background:#ffffff;border:1px solid #cccccc;font-family:Arial,Helvetica,sans-serif;">
      ...
      <tr><td style="padding:32px;color:#333333;font-size:14px;line-height:1.7;">
        ...
        <p style="margin:16px 0 0;background:#fce8e8;border-left:4px solid #cc0000;padding:12px 16px;color:#555555;font-size:13px;">If you did not request a password change, please ignore this email. Your current password will remain unchanged and no action is required.</p>
      </td></tr>
