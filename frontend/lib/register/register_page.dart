          ...
          children: [
            ...
            Padding(
              ...
              child: Row(children: [
                ...
                const SizedBox(width: 12),
                Text('Select Gender', style: TextStyle(fontSize: 17, fontWeight: FontWeight.bold, color: AppThemeColors.primaryText(ctx))),
              ]),
            ),
            const SizedBox(height: 16),
            Padding(
              ...
              child: Column(
                children: options.map((opt) {
                  ...
                  return GestureDetector(
                    onTap: () {
                      setState(() => _selectedGender = opt['value'] as String);
                      Navigator.pop(ctx);
                    },
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        border: Border.all(
                          color: isSelected ? AppColors.cyan.withValues(alpha: 0.5) : AppThemeColors.border(ctx),
                        ),
                      ),
                      child: Row(children: [
                        Container(
                          ...
                          decoration: BoxDecoration(
                            gradient: isSelected
                                ...
                                : null,
                            color: isSelected ? null : AppThemeColors.border(ctx).withValues(alpha: 0.3),
                            borderRadius: BorderRadius.circular(12),
                          ),
                          child: Icon(opt['icon'] as IconData,
                              color: isSelected ? Colors.white : AppThemeColors.secondaryText(ctx), size: 22),
                        ),
                        const SizedBox(width: 14),
                        ...
                        if (isSelected)
                          const Icon(Icons.check_circle_rounded, color: AppColors.cyan, size: 22),
                      ]),
                    ),
                  );
                }).toList(),
                  ...
                  children: [
                    ...
                    _profileStyleField(
                      ...
                      child: GestureDetector(
                        onTap: _detailsLocked ? null : () => _showGenderPicker(),
