...
class AppLocalizations {
  ...
  static const Map<String, Map<String, String>> _translations = {
    'en': {
      ...
      'allow_direct_community_add_title': 'Allow Direct Community Add',
      'allow_direct_community_add_desc': 'Let others add you to communities directly. Turn off to require an invite code instead.',
      'leaderboard_visible_title': 'Show on Leaderboard',
      'leaderboard_visible_desc': 'Allow your activity to appear in public leaderboards. Turn off to stay hidden.',
      'my_subscription': 'My Subscription',
      'my_subscription_desc': 'View your plan, features and upgrade options',
      'referral_and_rewards': 'Referral & Rewards',
      'referral_and_rewards_desc': 'Invite friends and earn LenDen coins',
      'contact_support': 'Contact Support',
      'submit_feedback': 'Submit Feedback',
      'rate_the_app': 'Rate the App',
      'share_app': 'Share App',
      'rate_app_share_text': 'I love using LenDen for splitting expenses! Try it out.',
      'share_app_text': 'Manage group expenses easily with LenDen — split bills, track debts and more!',
      'admin_insights': 'Admin Insights',
      'admin_insights_desc': 'Platform-wide analytics and intelligence',
      'track_users': 'Track Users',
      'track_users_desc': 'Monitor user behaviour and activity patterns',
      'monetization': 'Monetization',
      'subscription_plans': 'Subscription Plans',
      'subscription_plans_desc': 'Manage premium features and plans',
      'coin_pricing': 'Coin Pricing',
      'coin_pricing_desc': 'Configure LenDen coin costs per action',
      'currency_conversions_desc': 'Set exchange rates for supported currencies',
      'gift_cards': 'Gift Cards',
      'gift_cards_desc': 'Create and manage redeemable gift cards',
      'offers_desc': 'Run promotions and discount campaigns',
      'referral_settings_desc': 'Configure referral rewards and invite codes',
      'content_and_support': 'Content & Support',
      'contact_messages_desc': 'Review messages sent by users',
      'user_feedbacks_desc': 'Read and respond to user suggestions',
      'user_ratings_desc': 'View ratings users give each other',
      'fraud_alerts_desc': 'Review flagged suspicious activity',
      'disputes': 'Disputes',
      'disputes_desc': 'Manage user-raised transaction disputes',
      'default_currency': 'Default Currency',
      'filter_all': 'All',
      'filter_created_by_me': 'Created by me',
      'filter_joined': 'Joined',
      'filter_starred': 'Starred',
      'no_created_communities_title': 'No Communities Created',
      'no_created_communities_desc': 'You haven\'t created any communities yet. Start one to organise your groups.',
      'no_joined_communities_title': 'No Joined Communities',
      'no_joined_communities_desc': 'You haven\'t joined any community yet. Use an invite code to join one.',
      'no_starred_communities_title': 'No Starred Communities',
      'no_starred_communities_desc': 'Tap the ⭐ on any community card to star it and find it here quickly.',
      'no_posts_yet': 'No posts yet',
      'be_first_to_post': 'Be the first to post in this community!',
      'post_published': 'Post published!',
      'post_text_empty': 'Write something before posting.',
      ...
      'no_subscription_plans_available': 'No plans are available at the moment.\nPlease check back later.',
      ...
      // Coins page – buy sheet & history UI
      'buy_lenden_coins_title': 'Buy LenDen Coins',
      'how_many_coins_label': 'How many coins?',
      'total_cost_label': 'Total cost',
      'no_coin_history_title': 'No coin history found',
      'no_coin_history_subtitle': 'Your coin transactions will appear here',
      'view_remaining_label': 'View Remaining',
      'est_value_label': 'Est. Value',
      'about_coins_label': 'About Coins',
      'max_coins_per_purchase_error': 'Max 10,000 coins per purchase',
      'enter_at_least_one_coin_error': 'Enter at least 1 coin',
      'connection_error_retry_message': 'Connection error. Please try again.',
      ...
      'no_incoming_requests': 'No received requests',
      ...
      'starred_communities': 'Starred Communities',
      'no_starred_communities': 'No starred communities yet',
      'starred_communities_subtitle': 'starred',
      ...
      'share_as_note': 'Share as Note',
      'share_all_notes': 'Share All Notes',
      'share_all_as_single_note': 'Share All as Single Note',
      'share_all_as_individual_notes': 'Share All as Individual Notes',
      'delete_all': 'Delete All',
      'no_notes_to_share': 'No notes to share.',
      'self_share_note_message': 'That\'s you! You already have this note — no need to share it with yourself.',
      ...
      'join_community_code_hint': 'Enter the 6-character invite code shared by the admin',
      'join_community_btn': 'Join Community',
      'joined_community_success': 'Joined community successfully!',
      'search_communities_hint': 'Search communities…',
      'filter_member_label': 'Member',
      'no_communities_title': 'No Communities Yet',
      'no_communities_desc': 'Create a community to organize multiple groups — office, family, college, trips, and more.',
      'create_community_btn': 'Create Community',
      'join_with_invite_code_btn': 'Join with Invite Code',
      'community_created_success': 'Community created!',
      'clear_filters_label': 'Clear filters',
      'tab_overview': 'Overview',
      'tab_groups': 'Groups',
      'tab_members': 'Members',
      'community_settings_title': 'Community Settings',
      'copy_invite_code_label': 'Copy Invite Code',
      'upload_photo_label': 'Upload Photo',
      'edit_community_label': 'Edit Community',
      'delete_community_label': 'Delete Community',
      'delete_community_confirm_title': 'Delete Community?',
      'delete_community_confirm_body': 'This will unlink all groups. This action cannot be undone.',
      'invite_code_copied_snack': 'Invite code copied!',
      'code_copied_snack': 'Code copied!',
      'my_community_balance_label': 'MY BALANCE IN COMMUNITY',
      'invite_code_display_label': 'INVITE CODE',
      'no_groups_yet_label': 'No groups yet',
      'add_group_link_hint': 'Tap "Add Group" to link a group',
      'ask_admin_groups_hint': 'Ask an admin to add groups',
      'add_group_btn': 'Add Group',
      'add_group_to_community_title': 'Add Group to Community',
      'community_updated_snack': 'Community updated!',
      'photo_updated_snack': 'Photo updated!',
      'save_changes_btn': 'Save Changes',
      'community_name_label': 'Community Name',
      'color_picker_label': 'Color',
      'removed_from_community_snack': 'Removed from community',
      'group_removed_community_snack': 'Group removed from community',
      'group_added_community_snack': 'Group added to community!',
      'no_available_groups_snack': 'No available groups to add',
      'you_chip_label': 'You',
      'not_in_any_community_label': 'Not in any community yet',
      'add_to_community_label': 'Add to Community',
      'manage_communities_link': 'Manage →',
      'community_name_required_label': 'Community Name *',
      'community_color_section': 'Community Color',
      'community_photo_section': 'Community Photo',
      'tap_to_upload_photo_hint': 'Tap to upload a photo',
      'creating_label': 'Creating…',
      'please_enter_community_name': 'Please enter a community name',
      'failed_to_create_community': 'Failed to create community',
      'pick_color_label': 'Pick Color',
      'role_admin_badge': '★ Admin',
      'role_member_badge': 'Member',
      'failed_to_join_community': 'Failed to join community',
      'try_different_search_or_filter': 'Try a different name or adjust the filter.',
      'custom_color_label': 'Custom Color',
      'custom_color_row': 'Custom Color…',
      'apply_color_btn': 'Apply Color',
      'new_community_heading': 'New Community',
      'new_community_subheading': 'A space that holds multiple groups',
      'pick_community_color_title': 'Pick Community Color',
      'pick_community_color_desc': 'Choose a color that represents your community',
      'share_invite_btn': 'Share Invite',
      'copy_message_btn': 'Copy Message',
      'message_copied_snack': 'Message copied!',

      // Community page — invites strip, tabs, feed
      'tab_feed': 'Feed',
      'my_feed_tab': 'My Feed',
      'my_communities_tab': 'My Communities',
      'all_communities_label': 'All communities',
      'invited_to_join': 'Invited to join',
      'pending_invite_singular': 'pending invite',
      'pending_invite_plural': 'pending invites',
      'invite_declined': 'Invite declined',
      'decline_btn': 'Decline',
      'accept_btn': 'Accept',
      'community_feed_title': 'Community Feed',
      'community_feed_subscribe_desc': 'Subscribe to post and view community updates in the feed.',
      'upgrade_to_subscribe_btn': 'Upgrade to Subscribe',
      'subscribe_for_feed_snack': 'Subscribe to access Community Feed',
      'feed_write_placeholder': 'Write a post…',
      'publish_post_btn': 'Publish Post',
      ...
      'you_are_owed_label': 'YOU ARE OWED',
      'all_settled_label': 'ALL SETTLED',
      'you_owe_small': 'you owe',
      'you_are_owed_small': 'you\'re owed',
      'allow_direct_add_label': 'Allow direct member add',
      'allow_direct_add_on_desc': 'Admins can add members directly',
      'allow_direct_add_off_desc': 'Admins send invites instead',
      'send_invite_title': 'Send Invite',
      'direct_add_mode_desc': 'Member is added directly',
      'invite_mode_desc': 'Member receives an invite to accept',
      'enter_email_hint': 'Enter email address',

      // Community limit / coin cost strings
      'community_limit_reached': 'Community limit reached',
      'community_coin_cost_desc': 'Creating this community will cost',
      'community_coin_cost_balance': 'coins (you have',
      'not_enough_coins_need': 'Not enough coins. Need',
      'not_enough_coins_have': 'coins, you have',

      // Community card / member tab misc
      'view_community_btn': 'View Community →',
      'add_btn': 'Add',
      'deleted_account_label': 'Deleted Account',
      ...
      'activity_type_wallet_payment': 'Wallet Payment',
      'activity_type_wallet_pin_set': 'Wallet PIN Set',
      'activity_type_wallet_pin_removed': 'Wallet PIN Removed',
      'activity_type_withdrawal_requested': 'Withdrawal Requested',
      'activity_type_budget_expense_added': 'Budget Expense Added',
      'activity_type_budget_expense_deleted': 'Budget Expense Deleted',
      'activity_type_quick_transaction_paid': 'Quick Transaction Paid',
      'activity_type_note_shared': 'Note Shared',
    ...
    'hi': {
      ...
      'allow_direct_community_add_title': 'सीधे कम्युनिटी में जोड़ने की अनुमति',
      'leaderboard_visible_title': 'लीडरबोर्ड पर दिखाएं',
      'leaderboard_visible_desc': 'अपनी गतिविधि सार्वजनिक लीडरबोर्ड पर दिखाने की अनुमति दें। बंद करने पर छिपे रहें।',
      'my_subscription': 'मेरी सदस्यता',
      'my_subscription_desc': 'अपना प्लान, सुविधाएं और अपग्रेड विकल्प देखें',
      'referral_and_rewards': 'रेफरल और पुरस्कार',
      'referral_and_rewards_desc': 'दोस्तों को आमंत्रित करें और LenDen सिक्के कमाएं',
      'contact_support': 'सहायता से संपर्क करें',
      'submit_feedback': 'फ़ीडबैक दें',
      'rate_the_app': 'ऐप को रेट करें',
      'share_app': 'ऐप शेयर करें',
      'rate_app_share_text': 'मैं LenDen से खर्च बांटना पसंद करता हूं! आप भी इसे आज़माएं।',
      'share_app_text': 'LenDen से ग्रुप खर्च आसान करें — बिल बाँटें, कर्ज़ ट्रैक करें और बहुत कुछ!',
      'admin_insights': 'एडमिन अंतर्दृष्टि',
      'admin_insights_desc': 'प्लेटफ़ॉर्म-व्यापी विश्लेषण और जानकारी',
      'track_users': 'उपयोगकर्ता ट्रैक करें',
      'track_users_desc': 'उपयोगकर्ता व्यवहार और गतिविधि पैटर्न मॉनिटर करें',
      'monetization': 'मुद्रीकरण',
      'subscription_plans': 'सदस्यता योजनाएं',
      'subscription_plans_desc': 'प्रीमियम सुविधाएं और योजनाएं प्रबंधित करें',
      'coin_pricing': 'सिक्का मूल्य निर्धारण',
      'coin_pricing_desc': 'प्रति क्रिया LenDen सिक्का लागत कॉन्फ़िगर करें',
      'currency_conversions_desc': 'समर्थित मुद्राओं के लिए विनिमय दरें सेट करें',
      'gift_cards': 'उपहार कार्ड',
      'gift_cards_desc': 'रिडीम करने योग्य गिफ्ट कार्ड बनाएं और प्रबंधित करें',
      'offers_desc': 'प्रचार और छूट अभियान चलाएं',
      'referral_settings_desc': 'रेफरल पुरस्कार और आमंत्रण कोड कॉन्फ़िगर करें',
      'content_and_support': 'सामग्री और सहायता',
      'contact_messages_desc': 'उपयोगकर्ताओं द्वारा भेजे गए संदेशों की समीक्षा करें',
      'user_feedbacks_desc': 'उपयोगकर्ता सुझाव पढ़ें और जवाब दें',
      'user_ratings_desc': 'उपयोगकर्ता एक-दूसरे को दी गई रेटिंग देखें',
      'fraud_alerts_desc': 'संदिग्ध गतिविधि की समीक्षा करें',
      'disputes': 'विवाद',
      'disputes_desc': 'उपयोगकर्ता के लेनदेन विवादों का प्रबंधन करें',
      'default_currency': 'डिफ़ॉल्ट मुद्रा',
      'allow_direct_community_add_desc': 'दूसरों को आपको सीधे कम्युनिटी में जोड़ने दें। बंद करने पर इन्वाइट कोड ज़रूरी होगा।',
      'filter_all': 'सभी',
      'filter_created_by_me': 'मेरे द्वारा बनाए',
      'filter_joined': 'जॉइन किए',
      'filter_starred': 'स्टार किए',
      'no_created_communities_title': 'कोई कम्युनिटी नहीं बनाई',
      'no_created_communities_desc': 'आपने अभी तक कोई कम्युनिटी नहीं बनाई। अपने ग्रुप व्यवस्थित करने के लिए एक बनाएं।',
      'no_joined_communities_title': 'कोई जॉइन की हुई कम्युनिटी नहीं',
      'no_joined_communities_desc': 'आप अभी तक किसी कम्युनिटी से नहीं जुड़े हैं। जुड़ने के लिए इन्वाइट कोड का उपयोग करें।',
      'no_starred_communities_title': 'कोई स्टार किए समुदाय नहीं',
      'no_starred_communities_desc': 'किसी भी समुदाय कार्ड पर ⭐ दबाएं और उसे यहां जल्दी खोजें।',
      'no_posts_yet': 'अभी कोई पोस्ट नहीं',
      'be_first_to_post': 'इस कम्युनिटी में पहले पोस्ट करें!',
      'post_published': 'पोस्ट प्रकाशित!',
      'post_text_empty': 'पोस्ट करने से पहले कुछ लिखें।',
      ...
      'no_subscription_plans_available': 'अभी कोई प्लान उपलब्ध नहीं है।\nकृपया बाद में देखें।',
      ...
      // Coins page – buy sheet & history UI
      'buy_lenden_coins_title': 'LenDen कॉइन खरीदें',
      'how_many_coins_label': 'कितने कॉइन?',
      'total_cost_label': 'कुल लागत',
      'no_coin_history_title': 'कोई कॉइन हिस्ट्री नहीं मिली',
      'no_coin_history_subtitle': 'आपके कॉइन लेनदेन यहाँ दिखाई देंगे',
      'view_remaining_label': 'बाकी देखें',
      'est_value_label': 'अनुमानित मूल्य',
      'about_coins_label': 'कॉइन के बारे में',
      'max_coins_per_purchase_error': 'एक बार में अधिकतम 10,000 कॉइन',
      'enter_at_least_one_coin_error': 'कम से कम 1 कॉइन दर्ज करें',
      'connection_error_retry_message': 'कनेक्शन त्रुटि। पुनः प्रयास करें।',
      ...
      'no_incoming_requests': 'कोई प्राप्त रिक्वेस्ट नहीं',
      'no_sent_requests': 'कोई भेजी गई रिक्वेस्ट नहीं',
      ...
      'starred_communities': 'स्टार किए समुदाय',
      'no_starred_communities': 'अभी कोई स्टार किया समुदाय नहीं',
      'starred_communities_subtitle': 'स्टार किए',
      ...
      'share_as_note': 'नोट के रूप में शेयर करें',
      'share_all_notes': 'सभी नोट्स शेयर करें',
      'share_all_as_single_note': 'एक नोट में सभी शेयर करें',
      'share_all_as_individual_notes': 'अलग-अलग नोट्स शेयर करें',
      'delete_all': 'सभी हटाएं',
      'no_notes_to_share': 'शेयर करने के लिए कोई नोट नहीं।',
      'self_share_note_message': 'यह आप ही हैं! आपके पास पहले से यह नोट है — खुद को शेयर करने की ज़रूरत नहीं।',
      'tap_bookmark_hint': 'किसी भी नोट पर बुकमार्क आइकन दबाएं',
      // Admin backup/export (missing from HI)
      'available_exports': 'उपलब्ध निर्यात',
      'backup_created': 'बैकअप बनाया!',
      'backup_failed': 'बैकअप विफल:',
      'backup_files_not_found_on_disk': 'बैकअप फ़ाइलें डिस्क पर नहीं मिलीं।',
      'backup_history': 'बैकअप इतिहास',
      'backup_singular': 'बैकअप',
      'backups_plural': 'बैकअप',
      'clear_filters': 'फ़िल्टर साफ़ करें',
      'data_export_info_banner':
          'डेटा तालिका के रूप में देखने के लिए निर्यात दबाएं। CSV फ़ाइल भेजने के लिए शेयर/ईमेल का उपयोग करें।',
      'export_failed_try_again': 'निर्यात विफल। कृपया फिर से प्रयास करें।',
      'export_group_transactions_subtitle':
          'समूह शीर्षक, निर्माता, प्रत्येक खर्च राशि और तारीख के साथ',
      'export_quick_transactions_subtitle':
          'निर्माता, प्रतिभागी, भूमिका, राशि, निपटान स्थिति',
      'export_secure_transactions_subtitle':
          'उपयोगकर्ता ईमेल, प्रतिपक्ष, भूमिका, राशि, मुद्रा, स्थान',
      'export_support_subtitle':
          'सभी सहायता टिकट — उपयोगकर्ता, विषय, स्थिति, प्राथमिकता, तिथि',
      'export_users_subtitle':
          'सभी उपयोगकर्ता खाते — नाम, उपयोगकर्ता नाम, ईमेल, लिंग, जुड़ने की तिथि',
      'exported_data_from_admin_panel': 'LenDen एडमिन पैनल से निर्यात किया गया डेटा।',
      'file_not_found_on_disk': 'फ़ाइल डिस्क पर नहीं मिली।',
      'last_exported_label': 'अंतिम निर्यात',
      'no_backups_yet': 'अभी कोई बैकअप नहीं।\nऊपर अपना पहला बैकअप बनाएं।',
      'no_data_to_backup': 'बैकअप के लिए कोई डेटा नहीं।',
      'on_track_label': 'सही चल रहा है',
      'support_queries_label': 'सहायता प्रश्न',
      'users_and_support': 'उपयोगकर्ता और सहायता',
      // Communities
      'communities_title': 'समुदाय',
      'join_community_title': 'समुदाय में शामिल हों',
      'join_community_code_hint': 'एडमिन द्वारा साझा किया गया 6-अक्षर का कोड दर्ज करें',
      'join_community_btn': 'समुदाय में शामिल हों',
      'joined_community_success': 'समुदाय में सफलतापूर्वक शामिल हो गए!',
      'search_communities_hint': 'समुदाय खोजें…',
      'filter_member_label': 'सदस्य',
      'no_communities_title': 'अभी कोई समुदाय नहीं',
      'no_communities_desc': 'कई ग्रुप्स को व्यवस्थित करने के लिए समुदाय बनाएं — ऑफिस, परिवार, कॉलेज, यात्राएं आदि।',
      'create_community_btn': 'समुदाय बनाएं',
      'join_with_invite_code_btn': 'इनवाइट कोड से जुड़ें',
      'community_created_success': 'समुदाय बन गया!',
      'clear_filters_label': 'फ़िल्टर हटाएं',
      'tab_overview': 'अवलोकन',
      'tab_groups': 'ग्रुप्स',
      'tab_members': 'सदस्य',
      'community_settings_title': 'समुदाय सेटिंग्स',
      'copy_invite_code_label': 'इनवाइट कोड कॉपी करें',
      'upload_photo_label': 'फ़ोटो अपलोड करें',
      'edit_community_label': 'समुदाय संपादित करें',
      'delete_community_label': 'समुदाय हटाएं',
      'delete_community_confirm_title': 'समुदाय हटाएं?',
      'delete_community_confirm_body': 'इससे सभी ग्रुप्स अनलिंक हो जाएंगे। यह क्रिया वापस नहीं की जा सकती।',
      'invite_code_copied_snack': 'इनवाइट कोड कॉपी हो गया!',
      'code_copied_snack': 'कोड कॉपी हो गया!',
      'my_community_balance_label': 'समुदाय में मेरी बैलेंस',
      'invite_code_display_label': 'इनवाइट कोड',
      'no_groups_yet_label': 'अभी कोई ग्रुप नहीं',
      'add_group_link_hint': '"ग्रुप जोड़ें" पर टैप करें',
      'ask_admin_groups_hint': 'ग्रुप जोड़ने के लिए एडमिन से कहें',
      'add_group_btn': 'ग्रुप जोड़ें',
      'add_group_to_community_title': 'समुदाय में ग्रुप जोड़ें',
      'community_updated_snack': 'समुदाय अपडेट हो गया!',
      'photo_updated_snack': 'फ़ोटो अपडेट हो गई!',
      'save_changes_btn': 'बदलाव सहेजें',
      'community_name_label': 'समुदाय का नाम',
      'color_picker_label': 'रंग',
      'removed_from_community_snack': 'समुदाय से हटाया गया',
      'group_removed_community_snack': 'ग्रुप समुदाय से हटाया गया',
      'group_added_community_snack': 'ग्रुप समुदाय में जोड़ा गया!',
      'no_available_groups_snack': 'जोड़ने के लिए कोई ग्रुप उपलब्ध नहीं',
      'you_chip_label': 'आप',
      'not_in_any_community_label': 'अभी किसी समुदाय में नहीं',
      'add_to_community_label': 'समुदाय में जोड़ें',
      'manage_communities_link': 'प्रबंधित करें →',
      'community_name_required_label': 'समुदाय का नाम *',
      'community_color_section': 'समुदाय का रंग',
      'community_photo_section': 'समुदाय की फ़ोटो',
      'tap_to_upload_photo_hint': 'फ़ोटो अपलोड करने के लिए टैप करें',
      'creating_label': 'बनाया जा रहा है…',
      'please_enter_community_name': 'कृपया समुदाय का नाम दर्ज करें',
      'failed_to_create_community': 'समुदाय बनाने में विफल',
      'pick_color_label': 'रंग चुनें',
      'role_admin_badge': '★ एडमिन',
      'role_member_badge': 'सदस्य',
      'failed_to_join_community': 'समुदाय में शामिल होने में विफल',
      'try_different_search_or_filter': 'कोई अन्य नाम आज़माएं या फ़िल्टर बदलें।',
      'custom_color_label': 'कस्टम रंग',
      'custom_color_row': 'कस्टम रंग…',
      'apply_color_btn': 'रंग लागू करें',
      'new_community_heading': 'नया समुदाय',
      'new_community_subheading': 'कई ग्रुप्स को एक जगह रखने के लिए',
      'pick_community_color_title': 'समुदाय का रंग चुनें',
      'pick_community_color_desc': 'वह रंग चुनें जो आपके समुदाय को दर्शाए',
      ...
      // Community page — invites strip, tabs, feed
      'tab_feed': 'फ़ीड',
      'my_feed_tab': 'मेरी फ़ीड',
      'my_communities_tab': 'मेरे समुदाय',
      'all_communities_label': 'सभी समुदाय',
      'invited_to_join': 'शामिल होने का आमंत्रण',
      'pending_invite_singular': 'आमंत्रण लंबित',
      'pending_invite_plural': 'आमंत्रण लंबित',
      'invite_declined': 'आमंत्रण अस्वीकार किया',
      'decline_btn': 'अस्वीकार',
      'accept_btn': 'स्वीकार',
      'community_feed_title': 'समुदाय फ़ीड',
      'community_feed_subscribe_desc': 'पोस्ट करने और फ़ीड देखने के लिए सब्सक्राइब करें।',
      'upgrade_to_subscribe_btn': 'सब्सक्राइब करें',
      'subscribe_for_feed_snack': 'समुदाय फ़ीड देखने के लिए सब्सक्राइब करें',
      'feed_write_placeholder': 'अपनी पोस्ट यहाँ लिखें…',
      'publish_post_btn': 'पोस्ट करें',
      ...
      'you_are_owed_label': 'आपको मिलना है',
      'all_settled_label': 'सब सेटल',
      'you_owe_small': 'आप पर',
      'you_are_owed_small': 'आपको मिलेगा',
      'allow_direct_add_label': 'सीधे सदस्य जोड़ें',
      'allow_direct_add_on_desc': 'एडमिन सीधे सदस्य जोड़ सकते हैं',
      'allow_direct_add_off_desc': 'एडमिन इनवाइट भेजते हैं',
      'send_invite_title': 'इनवाइट भेजें',
      'direct_add_mode_desc': 'सदस्य सीधे जोड़ा जाएगा',
      'invite_mode_desc': 'सदस्य को इनवाइट स्वीकार करनी होगी',
      'enter_email_hint': 'ईमेल पता दर्ज करें',

      // Community limit / coin cost strings
      'community_limit_reached': 'समुदाय सीमा पूरी हो गई',
      'community_coin_cost_desc': 'इस समुदाय को बनाने में',
      'community_coin_cost_balance': 'कॉइन लगेंगे (आपके पास',
      'not_enough_coins_need': 'पर्याप्त कॉइन नहीं। चाहिए',
      'not_enough_coins_have': 'कॉइन, आपके पास',

      // Community card / member tab misc
      'view_community_btn': 'समुदाय देखें →',
      'add_btn': 'जोड़ें',
      'deleted_account_label': 'हटाया गया खाता',
      'member_singular': 'सदस्य',
      'member_plural': 'सदस्य',
      'group_singular': 'ग्रुप',
      'group_plural': 'ग्रुप्स',
      ...
      'activity_type_wallet_payment': 'वॉलेट भुगतान',
      'activity_type_wallet_pin_set': 'वॉलेट PIN सेट',
      'activity_type_wallet_pin_removed': 'वॉलेट PIN हटाया',
      'activity_type_withdrawal_requested': 'निकासी अनुरोध',
      'activity_type_budget_expense_added': 'बजट खर्च जोड़ा',
      'activity_type_budget_expense_deleted': 'बजट खर्च हटाया',
      'activity_type_quick_transaction_paid': 'क्विक लेन-देन भुगतान',
      'activity_type_note_shared': 'नोट साझा किया',
